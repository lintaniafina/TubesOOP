...
public abstract class Pegawai {
    private String nama, tgl_lahir, alamat, agama, status, no_hp, email;
    private double gaji;
    private Absen absen; 
    ...
    public Pegawai(String nama, String tgl_lahir, String alamat, String agama, String status, String no_hp, String email) {
        this.nama = nama;
