...
public class PegawaiKontrak extends Pegawai  {
    private String lamaKontrak, id_kontrak;
    private int kinerja;
    private Absen absen;

    public PegawaiKontrak( String nama, String tgl_lahir, String alamat, String agama, String no_hp, String email,String id_kontrak, String lamaKontrak,int kinerja ) {
